            ...
            override fun onResponse(call: Call<List<YourDataModel>>, response: Response<List<YourDataModel>>) {
                if (response.isSuccessful) {
                    ...
                    if (ultimos5Datos.size == 5) {
                        ...
                        findViewById<TextView>(R.id.tvData1).text = "Ultimo dato: ${ultimos5Datos[0].distance}, ${ultimos5Datos[0].unit}"
                        findViewById<TextView>(R.id.tvData2).text = "Campo 2: ${ultimos5Datos[1].distance}, ${ultimos5Datos[1].unit}"
                        findViewById<TextView>(R.id.tvData3).text = "Campo 3: ${ultimos5Datos[2].distance}, ${ultimos5Datos[2].unit}"
                        findViewById<TextView>(R.id.tvData4).text = "Campo 4: ${ultimos5Datos[3].distance}, ${ultimos5Datos[3].unit}"
                        findViewById<TextView>(R.id.tvData5).text = "Campo 5: ${ultimos5Datos[4].distance}, ${ultimos5Datos[4].unit}"
                    }
                } else {
